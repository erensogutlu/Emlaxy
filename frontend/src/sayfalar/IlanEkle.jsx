...
const IlanEkle = () => {
  ...
  const formGonder = async (e) => {
    ...
    try {
      ...
      console.error('İlan ekleme hatası:', hata);
    }
  };
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '2rem auto' }}>
      <div className="cam-panel" style={{ padding: '2rem' }}>
        <h2 style={{ marginBottom: '2rem' }}>Yeni İlan Ekle</h2>
        <form onSubmit={formGonder}>
          <div className="form-grubu">
            <label>İlan Başlığı</label>
            <input type="text" name="baslik" className="form-kontrol" required onChange={degisimAlici} />
          </div>
          
          <div className="form-grubu">
            <label>Açıklama</label>
            <textarea name="aciklama" className="form-kontrol" rows="4" onChange={degisimAlici}></textarea>
          </div>
          
          <div className="grid-izgarasi" style={{ gap: '1rem', marginBottom: '0' }}>
            <div className="form-grubu">
              <label>Fiyat (₺)</label>
              <input type="number" name="fiyat" className="form-kontrol" required onChange={degisimAlici} />
            </div>
          ...
          <div className="grid-izgarasi" style={{ gap: '1rem', marginBottom: '0' }}>
            <div className="form-grubu">
              ...
              <input type="text" name="oda_sayisi" className="form-kontrol" placeholder="Örn: 3+1" onChange={degisimAlici} />
            </div>
            
            <div className="form-grubu">
              <label>Metrekare</label>
              <input type="number" name="metrekare" className="form-kontrol" onChange={degisimAlici} />
            </div>
          </div>
          ...
          <div className="form-grubu">
            <label>Konum</label>
            <input type="text" name="konum" className="form-kontrol" placeholder="Örn: İstanbul, Kadıköy" onChange={degisimAlici} />
          </div>
          
          <div className="form-grubu">
            <label>Resim URL'leri (Birden fazla resim için virgülle ayırın)</label>
            <textarea name="resim_url" className="form-kontrol" placeholder="https://resim1.jpg, https://resim2.jpg" onChange={degisimAlici} rows="3"></textarea>
          </div>
